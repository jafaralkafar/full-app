...
module.exports = {
    register: async (req, res) => {
        // user inputs data: name, email, pw
        // check if email is in db, if yes send 409 status
        // create a salt
        // hash password & salt
        // store name, email, and has in table
        try {
    ...
    login: async (req, res) => {
        ...
        // compare pw with hash using bcrypt
        // if they dont match send 401 status
